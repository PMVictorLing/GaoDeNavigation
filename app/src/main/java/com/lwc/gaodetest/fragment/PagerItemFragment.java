package com.lwc.gaodetest.fragment;
...
public class PagerItemFragment extends Fragment {
    ...
    public static PagerItemFragment newInstance(String param1, String param2) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tvContent = (TextView)this.getActivity().findViewById(R.id.tv_content);
        String string = getArguments().get(ARG_PARAM1)+"";
